...
{block name=content}
    <div class="form__header">
        <form id="dash-cars-form" onsubmit="ajaxPostForm('dash-cars-form', '{url action='dashboardCarsList'}', 'dash-cars-table');
                return false;">
            <div class="form__forms">
                <h1 class="heading">Dashboard - Samochody</h1>
                <ul class="form__list">
                    <li class="form__item">
    ...
    <div class="cars__grid" id="dash-cars-table">
        {include file="DashboardCarsTable.tpl"}
    </div>
