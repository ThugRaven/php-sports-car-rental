...
<div class="car">
    ...
    <ul class="stats__list">
        <li class="stats__item">
            ...
            {if strlen($car['eng_info']) < 5 && !empty($car['eng_info'])}
...
<div class="swiper__container">
    ...
    <div class="swiper__buttons">
        <form method="post">
            {if $car_index > 1}
                {*<button onclick="ajaxPostForm('car_form', '{url action='mainContent' car=$car_index - 1}', 'content');
                return false;">*}
                <a onclick="ajaxPostForm('car_form', '{url action='mainContent' car=$car_index - 1}', 'content');
                        return false;">
