...
INSERT INTO `car_rent_db`.`car` (`id_car`, `id_car_price`, `license_plate`, `mileage`, `brand`, `model`, `eng_power`, `eng_torque`, `eng_info`, `eng_displacement`, `drive`, `time_100`, `top_speed`, `fuel_type`, `transmission_type`, `doors`, `seats`, `weight`, `fuel_capacity`, `fuel_consumption`, `rentable`) VALUES (10, 10, 'S0RENT10', 13450, 'Porsche', 'Taycan', 761, 1050, DEFAULT, DEFAULT, 'AWD', 2.8, 260, 'Electric', 'Automatic', 4, 4, 2370, NULL, NULL, 1);
INSERT INTO `car_rent_db`.`car` (`id_car`, `id_car_price`, `license_plate`, `mileage`, `brand`, `model`, `eng_power`, `eng_torque`, `eng_info`, `eng_displacement`, `drive`, `time_100`, `top_speed`, `fuel_type`, `transmission_type`, `doors`, `seats`, `weight`, `fuel_capacity`, `fuel_consumption`, `rentable`) VALUES (11, 11, 'S0RENT11', 37650, 'Toyota', 'GT86', 200, 205, DEFAULT, 2.0, 'RWD', 7.6, 225, 'Petrol', 'Manual', 2, 4, 1270, 50, 7.2, 1);
